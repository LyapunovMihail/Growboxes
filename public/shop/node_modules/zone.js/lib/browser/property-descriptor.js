...
function propertyDescriptorPatch(api, _global) {
    ...
    if (canPatchViaPropertyDescriptor()) {
        ...
        if (utils_1.isBrowser) {
            ...
            utils_1.patchOnProperties(window, exports.eventNames, Object.getPrototypeOf(window));
            utils_1.patchOnProperties(Document.prototype, exports.eventNames);
            if (typeof window['SVGElement'] !== 'undefined') {
                utils_1.patchOnProperties(window['SVGElement'].prototype, exports.eventNames);
            }
            utils_1.patchOnProperties(Element.prototype, exports.eventNames);
            utils_1.patchOnProperties(HTMLElement.prototype, exports.eventNames);
